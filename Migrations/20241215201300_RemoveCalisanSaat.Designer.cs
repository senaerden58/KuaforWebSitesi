...
namespace KuaforWebSitesi.Migrations
{
    ...
    [Migration("20241215201300_RemoveCalisanSaat")]
    partial class RemoveCalisanSaat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KuaforWebSitesi.Models.CalisanSaat", b =>
                {
                    b.Property<int>("CalisanSaatID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CalisanSaatID"));
            ...
            modelBuilder.Entity("KuaforWebSitesi.Models.CalisanSaat", b =>
                {
                    b.HasOne("KuaforWebSitesi.Models.Calisan", "Calisan")
                        .WithMany("CalisanSaatler")
                        .HasForeignKey("CalisanID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KuaforWebSitesi.Models.Gunler", "Gun")
                        .WithMany("CalisanSaatler")
                        .HasForeignKey("GunID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
